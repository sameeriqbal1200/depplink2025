                                        ...
                                        <React.Fragment key={i}>
                                            ...
                                            <div className="bg-white rounded-md shadow-md mb-4" key={pro.id}>
                                                <div className='flex items-center gap-x-4 relative'>
                                                    ...
                                                    {pro.regular_price > pro.price ? <div className='absolute text-[#EA4335] text-xs dayjs ltr:left-0 rtl:right-0 top-0 bg-[#EA433520] px-3.5 py-1 rtl:rounded-bl-lg ltr:rounded-br-lg ltr:rounded-tl-lg w-34'>{lang == 'ar' ? Math.round(((pro.regular_price - pro.price) * 100) / pro.regular_price) + '% خصم' : Math.round(((pro.regular_price - pro.price) * 100) / pro.regular_price) + '% OFF'}</div> : null}
