                    ...
                    <div className="grid md:grid-cols-2 md:gap-4 mt-3">
                        <div>
                            <Disclosure>
                                {({ open }) => (
                                    <div>
                                        <DisclosureButton className="flex w-full justify-between rounded-md text-left text-sm font-medium focus-visible:outline-none bg-[#EEF8FC] p-2 md:p-3 mb-1 text-[#21638C] ltr:text-left rtl:text-right">
