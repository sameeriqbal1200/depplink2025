...
export default function TamkeenPremiumBuy() {
    const { lang } = useApp();
        ...
        <>
            <div className="container py-4 max-md:pt-20">
                ...
                <div className="my-8 w-1/2 mx-auto">
                    <Link href={`/${lang}/giftcards`} className="flex items-center gap-x-1">
                        ...
                        <div className="w-1/2">
                            ...
                            <div className="py-5 px-2 bg-gray/10 mt-3 shadow-md rounded-md flex items-center gap-4">
                                <div className="text-xs">
                                    <label className="font-normal">{lang === 'ar' ? 'كمية' : 'Validity'}</label>
                                    <p className="font-semibold mt-2 text-sm text-[#000000]">1{' '}{lang === 'ar' ? 'سنة' : 'Year'}</p>
                                </div>

                                <div className="text-xs">
                                    <label className="font-normal">{lang === 'ar' ? 'الدفع ببطاقة الهدايا' : 'Tamkeen Premium (Silver)'}</label>
                                    <p className="font-semibold mt-2 text-sm text-[#000000]">{lang === 'ar' ? '' : 'SR'}{' '}5,00.00{' '}{lang === 'ar' ? 'ر.س' : ''}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-1/2">
                                ...
                                <div className='mt-2'>
                                    ...
                                    <div className="border border-[#dfdfdf70] focus-visible:outline-none hover:border-[#004B7A] bg-white rounded p-2">
                                        <div className="flex items-center gap-3 fill-[#004B7A]">
                                            ...
                                            <input id="iconLeft" type="text" placeholder={lang == 'ar' ? 'رقم التليفون' : 'Phone Number'} className="text-xs focus-visible:outline-none w-full" />
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div className="mt-5">
                                ...
                                <button className="bg-[#004B7A] focus-visible:outline-none w-full p-3 rounded-md text-white text-sm" aria-label="proceed-to-buy">
                                    {lang === 'ar' ? 'الشروع في الشراء' : 'Proceed to Pay'}
                                </button>
                            </div>
                        </div>
                    </div>
