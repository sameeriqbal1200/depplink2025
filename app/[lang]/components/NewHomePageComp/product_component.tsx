          ...
          <Link prefetch={false} scroll={false} href={productSlug}>
            <div className="relative w-full max-w-[305px] aspect-square mx-auto">
              ...
              <Image
                ...
                height={0}
                quality={100}
                className={`w-[305px] h-[285px] object-cover object-center rounded-2xl transition-opacity duration-300 ${isImageLoaded ? "opacity-100" : "opacity-0"
                  }`}
