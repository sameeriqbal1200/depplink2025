...
export default function MobileHeader(props: any) {
    ...
    const goBack = () => {
        if (props.redirect) {
            router.push(`/${lang}/${props.redirect}`);
    ...
    const BackIcon = () => (
        <button className="w-16" onClick={goBack}>
            <svg height="30" width="30" className={lang === 'ar' ? 'rotate-180' : ''} viewBox="0 0 24 24"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z" /></svg>
        </button>
    );
