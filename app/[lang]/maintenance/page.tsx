                                                ...
                                                activeTab3 === true ?
                                                    <div className="container">
                                                        ...
                                                        <div className="grid grid-cols-5 mt-4 w-full">
                                                            <div className="text-xs text-[#004B7A] font-medium text-center bg-[#D9D9D960] h-full flex items-center justify-center ">
                                                                <p className="p-4">{lang === 'ar' ? 'السبت' : 'Saturday'}</p>
                                                            </div>
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 bg-[#D9D9D960] grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Sat 9AM to 5PM" checked={radioval === 'Sat 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Sat 5PM to 12PM" checked={radioval === 'Sat 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                            ...
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Sun 9AM to 5PM" checked={radioval === 'Sun 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Sun 5PM to 12PM" checked={radioval === 'Sun 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                            ...
                                                            <div className="text-xs text-[#004B7A] font-medium text-center bg-[#D9D9D960] h-full flex items-center justify-center ">
                                                                <p className="p-4">{lang === 'ar' ? 'الاثنين' : 'Monday'}</p>
                                                            </div>
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 bg-[#D9D9D960] grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Mon 9AM to 5PM" checked={radioval === 'Mon 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Mon 5PM to 12PM" checked={radioval === 'Mon 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                            ...
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Tue 9AM to 5PM" checked={radioval === 'Tue 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Tue 5PM to 12PM" checked={radioval === 'Tue 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                            ...
                                                            <div className="text-xs text-[#004B7A] font-medium text-center bg-[#D9D9D960] h-full flex items-center justify-center ">
                                                                <p className="p-4">{lang === 'ar' ? 'الثلاثاء' : 'Wednesday'}</p>
                                                            </div>
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 bg-[#D9D9D960] grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Wed 9AM to 5PM" checked={radioval === 'Wed 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Wed 5PM to 12PM" checked={radioval === 'Wed 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                            ...
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Thu 9AM to 5PM" checked={radioval === 'Thu 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Thu 5PM to 12PM" checked={radioval === 'Thu 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                            ...
                                                            <div className="text-xs text-[#004B7A] font-medium text-center bg-[#D9D9D960] h-full flex items-center justify-center ">
                                                                <p className="p-4">{lang === 'ar' ? 'الجمعة' : 'Friday'}</p>
                                                            </div>
                                                            <div className="col-span-4 text-xs text-[#5D686F] font-medium">
                                                                <div className="p-4 bg-[#D9D9D960] grid grid-cols-2">
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Fri 9AM to 5PM" checked={radioval === 'Fri 9AM to 5PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                                                    ...
                                                                    <label className="inline-flex gap-x-2">
                                                                        <input type="radio" name="default_radio" className="form-radio !mr-0 md:!w-5 !w-4 md:!h-5 !h-4" value="Fri 5PM to 12PM" checked={radioval === 'Fri 5PM to 12PM'}
                                                                            onChange={(e: any) => {
                                                                                setRadioVal(e.target.value)
                                                                                setSelectedTime(e.target.value)
                                                                            }} />
                                        ...
                                        <div className="fixed bottom-0 py-3 bg-white w-full border-t border-[#00000010] flex items-center justify-between container gap-2">
                                            {activeTab2 === true || activeTab3 === true ?
                                                <button
                                                    ...
                                                    className="w-fit focus-visible:outline-none border border-[#004B7A] hover:bg-[#004B7A] hover:text-white text-[#004B7A] text-xs font-semibold px-3.5 py-3 rounded-md shadow-md hover:shadow-none"
                                                >
                                            ...
                                            <button
                                                ...
                                                className={`${selected == false ? 'border-[#219EBC] bg-[#219EBC] text-white' : 'border-[#004B7A] bg-[#004B7A] text-white'} w-fit focus-visible:outline-none border text-xs font-semibold px-3.5 py-3 rounded-md shadow-md hover:shadow-none`}
                                            >
